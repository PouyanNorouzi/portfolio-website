...
const projects = ref<Project[]>(
  [
    ...
    },
    {
      ...
      techStack: [SKILL_REACT, SKILL_TYPESCRIPT, SKILL_BUN, SKILL_NODEJS, SKILL_AWS, SKILL_LAMBDA, SKILL_DYNAMODB, SKILL_WEBSOCKET, SKILL_TAILWIND],
      tags: ["Academic Project", "Serverless", "E-Commerce", "Team Project"],
